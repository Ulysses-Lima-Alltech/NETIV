...
const PENDING_COMMERCIAL_FLOW_KEYS = [
  ...
  'pending_enterprise_id',
  'pendingVisitScheduling',
  'pendingVisitDateLabel',
  'pendingVisitDate',
  'pendingVisitDay',
  'pendingVisitTime',
  'pendingVisitPeriod',
  'pendingVisitEnterpriseId',
  'pendingVisitInvalidTime',
  'pendingVisitMissingSlot',
  'pendingVisitCustomerName',
  'pendingVisitConfirmationAsked',
  'pendingAppointmentCandidate',
  'suggestedVisitStartAt',
  'suggestedVisitEndAt',
  'suggestedVisitBrokerId',
  'suggestedVisitSlotLabel',
  'suggestedVisitTimezone',
  'suggestedVisitStatus',
  'awaitingAlternativeSlotInterest',
  'suggestedVisitDeclinedStartAt',
  'suggestedVisitDeclinedEndAt',
  'suggestedVisitDeclinedBrokerId',
  'suggestedVisitDeclinedSlotLabel',
  'suggestedVisitDeclinedTimezone',
  'visitScheduling',
] as const;

/**
 * Invalida, sem apagar mensagens ou histórico, todo trabalho automático ainda
 * pendente quando a conversa já está canonicamente em HANDOFF.
 */
