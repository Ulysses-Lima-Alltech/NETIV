...
function persist(base: CommercialFlowState, v: VisitState, enterpriseId: number | null): CommercialFlowState {
  ...
  return {
    ...
    pendingVisitDay: v.requestedDateText,
    ...
    pendingVisitCustomerName: v.active ? (v.customerName ?? null) : null,
    pendingVisitConfirmationAsked: v.active ? v.status === 'ready_to_confirm' : false,
    visitScheduling: v,
